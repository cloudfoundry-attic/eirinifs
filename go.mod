...
require (
	...
	code.cloudfoundry.org/buildpackapplifecycle v0.0.0-20191120185355-45f098c540a0
	code.cloudfoundry.org/bytefmt v0.0.0-20190819182555-854d396b647c
	code.cloudfoundry.org/cacheddownloader v0.0.0-20191025171633-45dd66a014fe
	code.cloudfoundry.org/credhub-cli v0.0.0-20191119172557-a0589223ffa9 // indirect
	...
	github.com/cloudfoundry-incubator/credhub-cli v0.0.0-20191119172557-a0589223ffa9
